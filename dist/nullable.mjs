...
var Nullable = /** @class */ (function () {
    ...
    Nullable.prototype.orThrow = function (error) {
        return new Nullable(this.value, __assign(__assign({}, this.state), { onUndefined: error }));
    };
    /**
    ...
    Nullable.prototype.isNullable = function () {
        return new Nullable(this.value, __assign(__assign({}, this.state), { allowNull: true }));
    };
    /**
    ...
    Nullable.prototype.use = function () {
        ...
        return new Nullable(this.value, __assign(__assign({}, this.state), { middleware: __spreadArray(__spreadArray([], this.state.middleware, true), middleware, true) }));
    };
    /**
