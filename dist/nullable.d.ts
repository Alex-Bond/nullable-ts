 ...
 */
type Middleware = <ValueType = unknown, ErrorState extends boolean = false, NullableState extends boolean = false>(current: Nullable<ValueType, ErrorState, NullableState>) => Nullable<ValueType, ErrorState, NullableState>;
